        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/60 text-sm mb-4">
              Premium matchmaking powered by science.
            </p>
            <div className="inline-flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full text-xs text-white/80">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-semibold mb-4 text-[var(--color-accent)]">
              Navigation
            </h4>
