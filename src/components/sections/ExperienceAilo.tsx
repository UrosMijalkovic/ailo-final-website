...
export function ExperienceAilo() {
  return (
    <section className="relative py-16 sm:py-24 md:py-32 bg-[#0a0a0a] overflow-hidden">
      <div className="container-custom relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {/* Path 1: Book a Call */}
            <div className="group p-5 sm:p-6 rounded-2xl bg-white/5 border border-white/8 hover:border-[var(--color-accent)]/20 transition-colors">
              {/* Icon */}
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[var(--color-accent)]/10 flex items-center justify-center mb-4 sm:mb-5">
            ...
            <div className="group p-5 sm:p-6 rounded-2xl bg-[var(--color-primary)]/5 border border-[var(--color-primary)]/10 hover:border-[var(--color-primary)]/25 transition-colors sm:col-span-2 md:col-span-1">
              {/* Icon */}
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[var(--color-primary)]/15 flex items-center justify-center mb-4 sm:mb-5">
